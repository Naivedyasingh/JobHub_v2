...
class PasswordValidator:
    ...
    def __init__(self, min_length=8, require_uppercase=True, require_lowercase=True, 
        ...
        self.special_pattern = re.compile(r"[!@#$%^&*(),.?\":{}|<>]")
    ...
    # NEW METHOD ADDED - Only change in this class
    def validate_password_detailed(self, password: str) -> tuple[bool, str]:
        """Validates password and returns specific error messages."""
        if not password or not isinstance(password, str):
...
class ValidationService:
    ...
    # NEW METHOD ADDED - Only change in this class
    def validate_password_detailed(self, password: str) -> tuple[bool, str]:
        return self.password_validator.validate_password_detailed(password)
...
# NEW FUNCTION ADDED - Only change at module level
def validate_password_detailed(password: str) -> tuple[bool, str]:
    """Password validation with specific error messages."""
    return _validation_service.validate_password_detailed(password)
